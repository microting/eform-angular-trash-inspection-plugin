...
import {TransporterPnHeadersModel, TransporterPnImportModel} from '../../../models/transporter';
...
export class TransporterImportComponent implements OnInit {
  ...
  importTransporter() {
    ...
    return this.transporterService.importTransporter(this.transporterImportModel).subscribe(((data) => {
